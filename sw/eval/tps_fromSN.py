#Decode the binary supernova (SN) file and plot the trigger primitives calculated from SN ROIs in channel vs time tick. Calculates TPs for a particular frame number which can be chosen in the starting (using variable "fr")
...
plt.title("Frame2, TPs from SN [Collection Plane Only]")                                                
plt.show()
